...
public class DataTypeTemplateAda {
  public static CharSequence create(final DataType dataType) {
    StringConcatenation _builder = new StringConcatenation();
    String _println = InputOutput.<String>println(dataType.getName());
    _builder.append(_println);
    _builder.newLineIfNotEmpty();
    {
      EList<PropertyAssociation> _ownedPropertyAssociations = dataType.getOwnedPropertyAssociations();
